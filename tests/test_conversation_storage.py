...
Contains both:
- Integration tests using Flask test client (TestConversationPersistence, etc.)
- Unit tests using ConversationStorage directly (TestConversationStorage)
"""
...
if _HAS_DASHBOARD:
    ...
    class TestConversationPersistence:
        """Test saving and loading conversations via Flask routes."""
...
# ---- Unit Tests (ConversationStorage directly) ----
